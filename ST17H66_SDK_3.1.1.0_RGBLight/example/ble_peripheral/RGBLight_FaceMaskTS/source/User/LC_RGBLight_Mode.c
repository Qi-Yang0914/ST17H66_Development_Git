...
{
	LC_RGBLight_Param.RGB_rValue_New	=	128;
	LC_RGBLight_Param.RGB_gValue_New	=	128;
	LC_RGBLight_Param.RGB_bValue_New	=	0;
#if(LC_RGBLight_Module ==	RGBWLight)
	LC_RGBLight_Param.RGB_wValue_New	=	0;
	LC_RGBLight_Param.RGB_wValue		=	0;
...
void	LC_RGBLight_Static_Cyan(void)
{
	LC_RGBLight_Param.RGB_rValue_New	=	0;
	LC_RGBLight_Param.RGB_gValue_New	=	128;
	LC_RGBLight_Param.RGB_bValue_New	=	128;
#if(LC_RGBLight_Module ==	RGBWLight)
	LC_RGBLight_Param.RGB_wValue_New	=	0;
	LC_RGBLight_Param.RGB_wValue		=	0;
#endif
...
void	LC_RGBLight_Mode_Jump(uint8 jump_color_num, const uint8 *rgb_data, uint16 jump_speed)
{
	if(LC_RGBLight_Modetick > jump_speed){
		...
		LC_RGBLight_Param.RGB_rValue	=	(*(rgb_data + LC_RGBLight_Param.RGB_Mode_Change_Color_Num*3))*LC_RGBLight_Param.RGB_Light_Level/RGB_LEVEL_PECENT;;
		LC_RGBLight_Param.RGB_gValue	=	(*(rgb_data + LC_RGBLight_Param.RGB_Mode_Change_Color_Num*3 + 1))*LC_RGBLight_Param.RGB_Light_Level/RGB_LEVEL_PECENT;;
		LC_RGBLight_Param.RGB_bValue	=	(*(rgb_data + LC_RGBLight_Param.RGB_Mode_Change_Color_Num*3 + 2))*LC_RGBLight_Param.RGB_Light_Level/RGB_LEVEL_PECENT;;
	#if(LC_RGBLight_Module ==	RGBWLight)
		LC_RGBLight_Param.RGB_wValue	=	0;
	#endif
...
void	LC_RGBLight_Turn_Onoff(uint8 onoff)
{
	if(onoff){
		...
		}else if(LC_RGBLight_Param.RGB_Light_Mode == RGB_Jump_ThreeColors){
			LC_RGBLight_Modetick				=	0;
			LC_RGBLight_Param.RGB_Mode_Change_Color_Num	=	0;
...
void	LC_RGBLight_Dynamic_Mode_Process(void)
{
	...
	// }
	// else 
	if(LC_RGBLight_Param.RGB_Light_Mode == RGB_Jump_SevenColors){
